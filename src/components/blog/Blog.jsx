  ...
  return (
    <div className='custom-grid'>
        ...
        <div className="col-span-3 md:col-span-7 lg:col-span-11 grid grid-cols-3 md:grid-cols-7 lg:grid-cols-11 gap-2 md:gap-4 mb-64">
            <div className="col-span-3 md:col-span-5 lg:col-span-7 relative overflow-hidden rounded-xl group cursor-pointer">
                ...
                <div className="absolute bottom-0 left-0 right-0 px-8 max-w-3xl w-full mx-auto text-background my-8 p-8 bg-[#08304540] border-1 border-[#B6C3C940] backdrop-blur-lg flex items-center justify-between gap-8 rounded-2xl">
