...
const Hero = () => {
  ...
  return (
    <div id='hero' className='relative h-[svh] min-h-[526px] w-dvw overflow-hidden'>
        ...
        <div className="grid grid-cols-4 md:grid-cols-8 lg:grid-cols-12 gap-2 md:gap-4 lg:gap-8 px-2 md:px-4 lg:px-8 h-[100svh] min-h-[526px]">
