  ...
  return (
    <div ref={container} className='relative h-dvh overflow-hidden'>
        <div className='custom-grid h-full items-center lg:items-start'>
            ...
            <div ref={linkContainer} className="col-span-4 md:col-span-7 lg:col-span-11 grid grid-cols-4 md:grid-cols-7 lg:grid-cols-11 gap-2 md:gap-4 lg:gap-8 grid-row-2 items-end">
                <Link href='/' className="col-span-2 lg:col-span-1 row-start-1 pb-4 md:pb-0 leading-none"><span ref={el => links.current[0] = el}>Voltar ao topo</span></Link>
                <ul className='col-span-2 lg:col-start-3 lg:col-span-6 row-start-2 lg:row-start-1 grid md:hidden lg:grid gap-y-4'>
                    <li className='col-span-1 lg:col-start-1' ref={el => links.current[1] = el}><Link href='/'>Sobre</Link></li>
                    <li className='col-span-1 lg:col-start-3' ref={el => links.current[2] = el}><Link href='/'>Galeria</Link></li>
                    <li className='col-span-1 lg:col-start-5' ref={el => links.current[3] = el}><Link href='/'>Serviços</Link></li>
                </ul>
                <ul className='col-span-2 md:col-span-4 lg:col-span-1 row-start-2 md:row-start-1 lg:col-start-9 flex flex-col md:grid md:grid-cols-4 lg:flex lg:flex-col gap-y-4 md:gap-4'>
                    <li className='col-span-1' ref={el => links.current[4] = el}><Link href='/'>Instagram &#8599;</Link></li>
                    <li className='col-span-1' ref={el => links.current[5] = el}><Link href='/'>Dribble &#8599;</Link></li>
                    <li className='col-span-1' ref={el => links.current[6] = el}><Link href='/'>Linkedin &#8599;</Link></li>
                </ul>
                <Link href='/' className='col-span-2 md:col-span-1 row-start-1 pb-4 md:pb-0 lg:col-start-11'><span ref={el => links.current[7] = el}>&#169;CtrlDev</span></Link>
            </div>
        </div>
