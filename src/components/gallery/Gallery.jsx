    ...
    <div className='mt-32 md:mt-64'>
      ...
      <div className="custom-grid">
        <div className="col-span-3 md:col-span-7 lg:col-span-11 mt-32 md:mt-64 grid grid-cols-3 md:grid-cols-7 lg:grid-cols-11 gap-x-2 md:gap-x-4 lg:gap-x-8 gap-y-8 md:gap-y-12 lg:gap-y-16" style={{gridTemplateRows: 'auto auto repeat(4, auto)'}}>
          ...
          <div className="col-start-1 col-span-3 md:col-span-4 lg:col-span-6 row-start-3 mb-16">
            <ParallaxImage 
              src="/galeria2.webp" 
              alt="Mockup Dummy" 
          ...
          <div className="col-start-1 md:col-start-5 lg:col-start-7 col-span-3 md:col-span-3 lg:col-span-5 row-start-4 mb-16">
            <ParallaxImage 
              src="/galeria3.webp" 
              alt="Mockup Dummy" 
              className="rounded-lg max-h-[60dvh] overflow-hidden aspect-video"
          ...
          <div className="col-start-1 col-span-3 md:col-span-4 lg:col-span-6 row-start-5 mb-16">
            <ParallaxImage 
              src="/galeria4.webp" 
              alt="Mockup Dummy" 
              className="rounded-lg max-h-[60dvh] overflow-hidden aspect-video"
